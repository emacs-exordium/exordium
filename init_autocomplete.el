...
;;;
;;; To auto-complete C++ headers, set variable `pg/ac-c-header-trees' to the
;;; list of directories containing system include directory (or BDE package
;;; groups). For example:
;;;   (setq pg/ac-c-header-trees
