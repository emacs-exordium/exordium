...
(defun colors-solarized-night (&optional frame)
...
(defun colors-tomorrow-night (&optional frame)
  "sets the color theme for X-Windows"
  (interactive)
...
(defun colors-tomorrow-day (&optional frame)
  "sets the color theme for X-Windows"
  (interactive)
...
;; Key bindings
(define-key global-map [f4] 'colors-tomorrow-night)
(define-key global-map [f3] 'colors-tomorrow-day)
(define-key global-map [f5] 'colors-solarized-night)

;; Default
(colors-solarized-night)
