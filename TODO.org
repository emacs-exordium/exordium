...
* Next Items
** DONE remove packages from git (load them if needed)
** DONE fix duplicate key
** TODO try Projectile
** DONE BDE style: redundant include guards
** TODO BDE style: align function parameters
** TODO BDE style: fix bug in C-c =
