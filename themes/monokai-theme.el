...
names to which it refers are bound."
  (quote
   `(;; Standard faces
     (default
       ((,class (:foreground ,monokai-fg :background ,monokai-bg))))
     (shadow
      ((,class (:foreground ,monokai-comments))))
     (match
      ((,class (:background ,monokai-hl :foreground ,monokai-emph :weight bold))))
     (cursor
      ((,class (:foreground ,monokai-bg :background ,monokai-fg :inverse-video t))))
     (mouse
      ((,class (:foreground ,monokai-bg :background ,monokai-fg :inverse-video t))))
     (escape-glyph-face
     ...
     (link
      ((,class (:foreground ,blue :underline t :weight bold))))
     (link-visited
      ((,class (:foreground ,blue :underline t :weight normal))))
     (success
     ...
     (lazy-highlight
      ((,class (:foreground ,monokai-bg :background ,yellow :weight normal))))
     (escape-glyph
     ...
     (font-lock-builtin-face
       ((,class (:foreground ,red :weight normal))))
     ...
     (font-lock-regexp-grouping-construct
       ((,class (:foreground ,yellow :weight normal))))
     ...
     (compilation-column-face
      ((,class (:foreground ,cyan :underline nil))))
     (compilation-column-number
      ((,class (:inherit font-lock-doc-face :foreground ,cyan :underline nil))))
     (compilation-enter-directory-face
      ((,class (:foreground ,green :underline nil))))
     (compilation-error
      ((,class (:inherit error :underline nil))))
     (compilation-error-face
      ((,class (:foreground ,red :underline nil))))
     (compilation-face
      ((,class (:foreground ,monokai-fg :underline nil))))
     (compilation-info
      ((,class (:foreground ,monokai-comments :underline nil :bold nil))))
     (compilation-info-face
      ((,class (:foreground ,blue :underline nil))))
     ...
     (cua-rectangle
      ((,class (:inherit region :background ,magenta :foreground ,monokai-bg))))
     (cua-rectangle-noselect
      ((,class (:inherit region :background ,monokai-hl :foreground ,monokai-comments))))
     ...
     (dired-flagged
      ((,class (:foreground ,red))))
     (dired-header
      ((,class (:foreground ,monokai-bg :background ,blue))))
     (dired-ignored
     ...
     (dired-perm-write
      ((,class (:foreground ,monokai-fg :underline t))))
     (dired-symlink
      ((,class (:foreground ,cyan :weight normal :slant italic))))
     (dired-warning
     ...
     (isearch
      ((,class (:foreground ,monokai-bg :background ,magenta :weight normal))))
     (isearch-fail
      ((,class (:foreground ,red :background ,monokai-bg :bold t))))
     ...
     (region
      ((,class (:background ,monokai-hl :inherit t))))
     (secondary-selection
      ((,class (:background ,monokai-hl :inherit t))))
     (trailing-whitespace
     ...
     ;; auto-complete
     (ac-candidate-face
      ((,class (:background ,monokai-hl :foreground ,cyan))))
     (ac-selection-face
      ((,class (:background ,cyan-lc :foreground ,cyan-hc))))
     (ac-candidate-mouse-face
      ((,class (:background ,cyan-hc :foreground ,cyan-lc))))
     (ac-completion-face
      ((,class (:foreground ,monokai-emph :underline t))))
     (ac-gtags-candidate-face
      ((,class (:background ,monokai-hl :foreground ,blue))))
     (ac-gtags-selection-face
      ((,class (:background ,blue-lc :foreground ,blue-hc))))
     (ac-yasnippet-candidate-face
      ((,class (:background ,monokai-hl :foreground ,yellow))))
     (ac-yasnippet-selection-face
      ((,class (:background ,yellow-lc :foreground ,yellow-hc))))

     ;; auto highlight symbol
     (ahs-definition-face
      ((,class (:foreground ,magenta :background unspecified :slant normal))))
     (ahs-edit-mode-face
      ((,class (:foreground ,monokai-bg :background ,magenta))))
     (ahs-face
     ...
     (cscope-line-face
      ((,class (:foreground ,monokai-fg))))
     (cscope-mouse-face
      ((,class (:background ,blue :foreground ,monokai-fg))))
     ...
     ;; diff
     (diff-added
      ((,class (:foreground ,green :background ,monokai-bg))))
     (diff-changed
      ((,class (:foreground ,blue :background ,monokai-bg))))
     (diff-removed
      ((,class (:foreground ,red :background ,monokai-bg))))
     (diff-header
      ((,class (:background ,monokai-bg))))
     (diff-file-header
      ((,class (:background ,monokai-bg :foreground ,monokai-fg :weight bold))))
     (diff-refine-added
      ((,class :foreground ,monokai-bg :background ,green)))
     (diff-refine-change
      ((,class :foreground ,monokai-bg :background ,blue)))
     (diff-refine-removed
      ((,class (:foreground ,monokai-bg :background ,red))))
     ...
     (ediff-even-diff-A
      ((,class (:background ,monokai-comments :foreground ,monokai-fg-lc ))))
     (ediff-odd-diff-A
      ((,class (:background ,monokai-comments :foreground ,monokai-fg-hc ))))
     (ediff-even-diff-B
      ((,class (:background ,monokai-comments :foreground ,monokai-fg-hc ))))
     (ediff-odd-diff-B
      ((,class (:background ,monokai-comments :foreground ,monokai-fg-lc ))))
     (ediff-even-diff-C
      ((,class (:background ,monokai-comments :foreground ,monokai-fg ))))
     (ediff-odd-diff-C
      ((,class (:background ,monokai-comments :foreground ,monokai-bg ))))
     ...
     (ido-incomplete-regexp
      ((,class (:foreground ,red :weight bold ))))
     (ido-indicator
      ((,class (:background ,red :foreground ,monokai-bg :width condensed))))
     (ido-virtual
